    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'phasespace_msgs_ros2.msg.Markers')
            logger.debug(
            ...
            from phasespace_msgs_ros2.msg import Marker
...
class Markers(metaclass=Metaclass_Markers):
    ...
    _fields_and_field_types = {
        ...
        'markers': 'sequence<phasespace_msgs_ros2/Marker>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['phasespace_msgs_ros2', 'msg'], 'Marker')),  # noqa: E501
    )

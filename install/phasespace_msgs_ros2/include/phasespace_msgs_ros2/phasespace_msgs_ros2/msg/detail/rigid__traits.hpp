...
#ifndef PHASESPACE_MSGS_ROS2__MSG__DETAIL__RIGID__TRAITS_HPP_
#define PHASESPACE_MSGS_ROS2__MSG__DETAIL__RIGID__TRAITS_HPP_
...
inline void to_yaml(
  const phasespace_msgs_ros2::msg::Rigid & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const phasespace_msgs_ros2::msg::Rigid & msg)
{
  return phasespace_msgs_ros2::msg::to_yaml(msg);
}

template<>
inline const char * data_type<phasespace_msgs_ros2::msg::Rigid>()
{
  return "phasespace_msgs_ros2::msg::Rigid";
}

template<>
inline const char * name<phasespace_msgs_ros2::msg::Rigid>()
{
  return "phasespace_msgs_ros2/msg/Rigid";
}

template<>
struct has_fixed_size<phasespace_msgs_ros2::msg::Rigid>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<phasespace_msgs_ros2::msg::Rigid>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<phasespace_msgs_ros2::msg::Rigid>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // PHASESPACE_MSGS_ROS2__MSG__DETAIL__RIGID__TRAITS_HPP_

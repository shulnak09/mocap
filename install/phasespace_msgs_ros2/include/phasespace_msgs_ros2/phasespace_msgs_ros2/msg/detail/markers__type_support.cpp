...
{
  new (message_memory) phasespace_msgs_ros2::msg::Markers(_init);
}

void Markers_fini_function(void * message_memory)
{
  auto typed_message = static_cast<phasespace_msgs_ros2::msg::Markers *>(message_memory);
  typed_message->~Markers();
}

size_t size_function__Markers__markers(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<phasespace_msgs_ros2::msg::Marker> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<phasespace_msgs_ros2::msg::Marker> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<phasespace_msgs_ros2::msg::Marker> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const phasespace_msgs_ros2::msg::Marker *>(
    get_const_function__Markers__markers(untyped_member, index));
  auto & value = *reinterpret_cast<phasespace_msgs_ros2::msg::Marker *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<phasespace_msgs_ros2::msg::Marker *>(
    get_function__Markers__markers(untyped_member, index));
  const auto & value = *reinterpret_cast<const phasespace_msgs_ros2::msg::Marker *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Markers_message_member_array[2] = {
  {
    ...
    offsetof(phasespace_msgs_ros2::msg::Markers, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<phasespace_msgs_ros2::msg::Marker>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(phasespace_msgs_ros2::msg::Markers, markers),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Markers_message_members = {
  "phasespace_msgs_ros2::msg",  // message namespace
  "Markers",  // message name
  2,  // number of fields
  sizeof(phasespace_msgs_ros2::msg::Markers),
...
get_message_type_support_handle<phasespace_msgs_ros2::msg::Markers>()
{
  return &::phasespace_msgs_ros2::msg::rosidl_typesupport_introspection_cpp::Markers_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, phasespace_msgs_ros2, msg, Markers)() {
  return &::phasespace_msgs_ros2::msg::rosidl_typesupport_introspection_cpp::Markers_message_type_support_handle;
}

...
#include "phasespace_msgs_ros2/msg/detail/marker__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = phasespace_msgs_ros2::msg::Marker;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const phasespace_msgs_ros2::msg::Marker *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<phasespace_msgs_ros2::msg::Marker *>(
    untyped_ros_message);
...
{
  return &phasespace_msgs_ros2::msg::typesupport_fastrtps_cpp::_Marker__handle;
}

...
#include "phasespace_msgs_ros2/msg/detail/markers__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const phasespace_msgs_ros2::msg::Marker &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  phasespace_msgs_ros2::msg::Marker &);
size_t get_serialized_size(
  const phasespace_msgs_ros2::msg::Marker &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const phasespace_msgs_ros2::msg::Markers & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: markers
  {
    ...
    for (size_t i = 0; i < size; i++) {
      phasespace_msgs_ros2::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  phasespace_msgs_ros2::msg::Markers & ros_message)
{
  // Member: header
  ...
  // Member: markers
  {
    ...
    for (size_t i = 0; i < size; i++) {
      phasespace_msgs_ros2::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: markers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        phasespace_msgs_ros2::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: markers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        phasespace_msgs_ros2::msg::typesupport_fastrtps_cpp::max_serialized_size_Marker(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = phasespace_msgs_ros2::msg::Markers;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const phasespace_msgs_ros2::msg::Markers *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<phasespace_msgs_ros2::msg::Markers *>(
    untyped_ros_message);
...
{
  return &phasespace_msgs_ros2::msg::typesupport_fastrtps_cpp::_Markers__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, phasespace_msgs_ros2, msg, Markers)() {
  return &phasespace_msgs_ros2::msg::typesupport_fastrtps_cpp::_Markers__handle;
}

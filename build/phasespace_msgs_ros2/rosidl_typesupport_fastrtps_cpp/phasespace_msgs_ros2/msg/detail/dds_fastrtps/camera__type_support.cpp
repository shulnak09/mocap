...
#include "phasespace_msgs_ros2/msg/detail/camera__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const phasespace_msgs_ros2::msg::Camera & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  phasespace_msgs_ros2::msg::Camera & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = phasespace_msgs_ros2::msg::Camera;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const phasespace_msgs_ros2::msg::Camera *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<phasespace_msgs_ros2::msg::Camera *>(
    untyped_ros_message);
...
{
  return &phasespace_msgs_ros2::msg::typesupport_fastrtps_cpp::_Camera__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, phasespace_msgs_ros2, msg, Camera)() {
  return &phasespace_msgs_ros2::msg::typesupport_fastrtps_cpp::_Camera__handle;
}

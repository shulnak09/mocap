...
static const _Markers_type_support_symbol_names_t _Markers_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, phasespace_msgs_ros2, msg, Markers)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, phasespace_msgs_ros2, msg, Markers)),
  }
};
...
{
  return &::phasespace_msgs_ros2::msg::rosidl_typesupport_cpp::Markers_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, phasespace_msgs_ros2, msg, Markers)() {
  return get_message_type_support_handle<phasespace_msgs_ros2::msg::Markers>();
}

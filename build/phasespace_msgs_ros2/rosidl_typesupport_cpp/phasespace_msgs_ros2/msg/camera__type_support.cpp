...
static const _Camera_type_support_symbol_names_t _Camera_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, phasespace_msgs_ros2, msg, Camera)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, phasespace_msgs_ros2, msg, Camera)),
  }
};
...
get_message_type_support_handle<phasespace_msgs_ros2::msg::Camera>()
{
  return &::phasespace_msgs_ros2::msg::rosidl_typesupport_cpp::Camera_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, phasespace_msgs_ros2, msg, Camera)() {
  return get_message_type_support_handle<phasespace_msgs_ros2::msg::Camera>();
}

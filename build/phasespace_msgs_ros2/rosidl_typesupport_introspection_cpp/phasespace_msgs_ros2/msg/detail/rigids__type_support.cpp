...
{
  new (message_memory) phasespace_msgs_ros2::msg::Rigids(_init);
}

void Rigids_fini_function(void * message_memory)
{
  auto typed_message = static_cast<phasespace_msgs_ros2::msg::Rigids *>(message_memory);
  typed_message->~Rigids();
}

size_t size_function__Rigids__rigids(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<phasespace_msgs_ros2::msg::Rigid> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<phasespace_msgs_ros2::msg::Rigid> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<phasespace_msgs_ros2::msg::Rigid> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const phasespace_msgs_ros2::msg::Rigid *>(
    get_const_function__Rigids__rigids(untyped_member, index));
  auto & value = *reinterpret_cast<phasespace_msgs_ros2::msg::Rigid *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<phasespace_msgs_ros2::msg::Rigid *>(
    get_function__Rigids__rigids(untyped_member, index));
  const auto & value = *reinterpret_cast<const phasespace_msgs_ros2::msg::Rigid *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Rigids_message_member_array[2] = {
  {
    ...
    offsetof(phasespace_msgs_ros2::msg::Rigids, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<phasespace_msgs_ros2::msg::Rigid>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(phasespace_msgs_ros2::msg::Rigids, rigids),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Rigids_message_members = {
  ...
  "Rigids",  // message name
  2,  // number of fields
  sizeof(phasespace_msgs_ros2::msg::Rigids),
...
get_message_type_support_handle<phasespace_msgs_ros2::msg::Rigids>()
{
  return &::phasespace_msgs_ros2::msg::rosidl_typesupport_introspection_cpp::Rigids_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, phasespace_msgs_ros2, msg, Rigids)() {
  return &::phasespace_msgs_ros2::msg::rosidl_typesupport_introspection_cpp::Rigids_message_type_support_handle;
}

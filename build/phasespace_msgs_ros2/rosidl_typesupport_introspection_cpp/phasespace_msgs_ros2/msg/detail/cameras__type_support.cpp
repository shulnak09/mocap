...
{
  new (message_memory) phasespace_msgs_ros2::msg::Cameras(_init);
}

void Cameras_fini_function(void * message_memory)
{
  auto typed_message = static_cast<phasespace_msgs_ros2::msg::Cameras *>(message_memory);
  typed_message->~Cameras();
}

size_t size_function__Cameras__cameras(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<phasespace_msgs_ros2::msg::Camera> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<phasespace_msgs_ros2::msg::Camera> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<phasespace_msgs_ros2::msg::Camera> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const phasespace_msgs_ros2::msg::Camera *>(
    get_const_function__Cameras__cameras(untyped_member, index));
  auto & value = *reinterpret_cast<phasespace_msgs_ros2::msg::Camera *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<phasespace_msgs_ros2::msg::Camera *>(
    get_function__Cameras__cameras(untyped_member, index));
  const auto & value = *reinterpret_cast<const phasespace_msgs_ros2::msg::Camera *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Cameras_message_member_array[2] = {
  {
    ...
    offsetof(phasespace_msgs_ros2::msg::Cameras, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<phasespace_msgs_ros2::msg::Camera>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(phasespace_msgs_ros2::msg::Cameras, cameras),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Cameras_message_members = {
  ...
  2,  // number of fields
  sizeof(phasespace_msgs_ros2::msg::Cameras),
...
{
  return &::phasespace_msgs_ros2::msg::rosidl_typesupport_introspection_cpp::Cameras_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, phasespace_msgs_ros2, msg, Cameras)() {
  return &::phasespace_msgs_ros2::msg::rosidl_typesupport_introspection_cpp::Cameras_message_type_support_handle;
}

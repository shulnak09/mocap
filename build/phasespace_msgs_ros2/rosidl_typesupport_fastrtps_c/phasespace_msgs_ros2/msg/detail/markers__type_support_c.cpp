...
#include "phasespace_msgs_ros2/msg/detail/markers__rosidl_typesupport_fastrtps_c.h"
...
#include "phasespace_msgs_ros2/msg/detail/marker__functions.h"  // markers
...
using _Markers__ros_msg_type = phasespace_msgs_ros2__msg__Markers;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: markers
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, phasespace_msgs_ros2, msg, Marker
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: markers
  {
    ...
    if (ros_message->markers.data) {
      phasespace_msgs_ros2__msg__Marker__Sequence__fini(&ros_message->markers);
    }
...
size_t get_serialized_size_phasespace_msgs_ros2__msg__Markers(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Markers__ros_msg_type * ros_message = static_cast<const _Markers__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name markers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_phasespace_msgs_ros2__msg__Marker(
...
static uint32_t _Markers__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_phasespace_msgs_ros2__msg__Markers(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_phasespace_msgs_ros2
size_t max_serialized_size_phasespace_msgs_ros2__msg__Markers(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: markers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_phasespace_msgs_ros2__msg__Marker(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = phasespace_msgs_ros2__msg__Markers;
    is_plain =
      (
...
static size_t _Markers__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_phasespace_msgs_ros2__msg__Markers(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, phasespace_msgs_ros2, msg, Markers)() {

...
#include "phasespace_msgs_ros2/msg/detail/rigid__rosidl_typesupport_fastrtps_c.h"
...
using _Rigid__ros_msg_type = phasespace_msgs_ros2__msg__Rigid;
...
static uint32_t _Rigid__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_phasespace_msgs_ros2__msg__Rigid(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = phasespace_msgs_ros2__msg__Rigid;
    is_plain =
      (
...
static size_t _Rigid__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_phasespace_msgs_ros2__msg__Rigid(

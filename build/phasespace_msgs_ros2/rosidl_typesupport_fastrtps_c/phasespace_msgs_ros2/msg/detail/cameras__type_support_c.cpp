...
#include "phasespace_msgs_ros2/msg/detail/cameras__rosidl_typesupport_fastrtps_c.h"
...
#include "phasespace_msgs_ros2/msg/detail/camera__functions.h"  // cameras
...
using _Cameras__ros_msg_type = phasespace_msgs_ros2__msg__Cameras;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: cameras
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, phasespace_msgs_ros2, msg, Camera
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: cameras
  {
    ...
    if (ros_message->cameras.data) {
      phasespace_msgs_ros2__msg__Camera__Sequence__fini(&ros_message->cameras);
    }
...
size_t get_serialized_size_phasespace_msgs_ros2__msg__Cameras(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Cameras__ros_msg_type * ros_message = static_cast<const _Cameras__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name cameras
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_phasespace_msgs_ros2__msg__Camera(
...
static uint32_t _Cameras__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_phasespace_msgs_ros2__msg__Cameras(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_phasespace_msgs_ros2
size_t max_serialized_size_phasespace_msgs_ros2__msg__Cameras(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: cameras
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_phasespace_msgs_ros2__msg__Camera(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = phasespace_msgs_ros2__msg__Cameras;
    is_plain =
      (
...
static size_t _Cameras__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_phasespace_msgs_ros2__msg__Cameras(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, phasespace_msgs_ros2, msg, Cameras)() {

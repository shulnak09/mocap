...
bool phasespace_msgs_ros2__msg__marker__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("phasespace_msgs_ros2.msg._marker.Marker", full_classname_dest, 39) == 0);
  }
  phasespace_msgs_ros2__msg__Marker * ros_message = _ros_message;
  {  // id
...
PyObject * phasespace_msgs_ros2__msg__marker__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("phasespace_msgs_ros2.msg._marker");

...
phasespace_msgs_ros2__msg__Markers__init(phasespace_msgs_ros2__msg__Markers * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    phasespace_msgs_ros2__msg__Markers__fini(msg);
    return false;
  }
  // markers
  if (!phasespace_msgs_ros2__msg__Marker__Sequence__init(&msg->markers, 0)) {
    phasespace_msgs_ros2__msg__Markers__fini(msg);
    return false;
  }
  return true;
...
phasespace_msgs_ros2__msg__Markers__fini(phasespace_msgs_ros2__msg__Markers * msg)
{
  ...
  // markers
  phasespace_msgs_ros2__msg__Marker__Sequence__fini(&msg->markers);
}
...
phasespace_msgs_ros2__msg__Markers__are_equal(const phasespace_msgs_ros2__msg__Markers * lhs, const phasespace_msgs_ros2__msg__Markers * rhs)
{
  ...
  // markers
  if (!phasespace_msgs_ros2__msg__Marker__Sequence__are_equal(
  ...
  phasespace_msgs_ros2__msg__Markers * output)
{
  ...
  // markers
  if (!phasespace_msgs_ros2__msg__Marker__Sequence__copy(
...
phasespace_msgs_ros2__msg__Markers__create()
{
  ...
  phasespace_msgs_ros2__msg__Markers * msg = (phasespace_msgs_ros2__msg__Markers *)allocator.allocate(sizeof(phasespace_msgs_ros2__msg__Markers), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(phasespace_msgs_ros2__msg__Markers));
  bool success = phasespace_msgs_ros2__msg__Markers__init(msg);
  if (!success) {
...
phasespace_msgs_ros2__msg__Markers__Sequence__init(phasespace_msgs_ros2__msg__Markers__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  phasespace_msgs_ros2__msg__Markers * data = NULL;

  if (size) {
    data = (phasespace_msgs_ros2__msg__Markers *)allocator.zero_allocate(size, sizeof(phasespace_msgs_ros2__msg__Markers), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = phasespace_msgs_ros2__msg__Markers__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        phasespace_msgs_ros2__msg__Markers__fini(&data[i - 1]);
      }
...
phasespace_msgs_ros2__msg__Markers__Sequence__fini(phasespace_msgs_ros2__msg__Markers__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      phasespace_msgs_ros2__msg__Markers__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  phasespace_msgs_ros2__msg__Markers__Sequence * array = (phasespace_msgs_ros2__msg__Markers__Sequence *)allocator.allocate(sizeof(phasespace_msgs_ros2__msg__Markers__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = phasespace_msgs_ros2__msg__Markers__Sequence__init(array, size);
  if (!success) {
...
phasespace_msgs_ros2__msg__Markers__Sequence__destroy(phasespace_msgs_ros2__msg__Markers__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    phasespace_msgs_ros2__msg__Markers__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
phasespace_msgs_ros2__msg__Markers__Sequence__are_equal(const phasespace_msgs_ros2__msg__Markers__Sequence * lhs, const phasespace_msgs_ros2__msg__Markers__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!phasespace_msgs_ros2__msg__Markers__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  phasespace_msgs_ros2__msg__Markers__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(phasespace_msgs_ros2__msg__Markers);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    phasespace_msgs_ros2__msg__Markers * data =
      (phasespace_msgs_ros2__msg__Markers *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!phasespace_msgs_ros2__msg__Markers__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          phasespace_msgs_ros2__msg__Markers__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!phasespace_msgs_ros2__msg__Markers__copy(
